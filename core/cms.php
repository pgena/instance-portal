...
class cmsCore {
    ...
    public static function checkContentAccess($access_list){
        ...
        $access_list = self::yamlToArray($access_list);
    ...
    public static function htmlCleanUp($text){
		...
		if(!isset(self::$jevix)){
			...
			self::$jevix->cfgAllowTagParams('img', array('src', 'style', 'alt' => '#text', 'title', 'align' => array('right', 'left', 'center'), 'width' => '#int', 'height' => '#int', 'hspace' => '#int', 'vspace' => '#int'));
